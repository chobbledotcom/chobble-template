...
const ALLOWED_NULL_CHECKS = new Set([
  ...
  "src/assets/js/quote-steps.js:38", // container (standalone init)
  "src/assets/js/quote-steps.js:41", // dataScript (standalone init)
  "src/assets/js/quote-steps.js:82", // field (field recap item)
  "src/assets/js/quote-steps.js:200", // container (init)
  "src/assets/js/quote-steps.js:250", // indicator (click handler)
