...
const ALLOWED_TRY_CATCHES = new Set([
  ...
  "test/eleventy/jsonld-validation.test.js:33",
]);
...
const ALLOWED_NULL_CHECKS = new Set([
  ...
  "test/eleventy/jsonld-validation.test.js:32", // match (regex result can be null)
  "test/eleventy/jsonld-validation.test.js:46", // jsonLd (can be null)
  "test/eleventy/jsonld-validation.test.js:68", // jsonLd (validation check)
  "test/eleventy/jsonld-validation.test.js:93", // entity (can be null)
]);
