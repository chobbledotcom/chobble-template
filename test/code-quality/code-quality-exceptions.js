...
const ALLOWED_NULLISH_COALESCING = frozenSet([
  ...
  "src/_data/eleventyComputed.js:81", // order
  "src/_data/eleventyComputed.js:87", // faqs
  "src/_data/eleventyComputed.js:96", // tab.body defaults to empty string
  "src/_data/eleventyComputed.js:111", // metaComputed defaults to {} for schema building
