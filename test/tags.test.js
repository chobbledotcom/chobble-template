...
const testCases = [
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['css', 'javascript', 'nodejs', 'web'], "Should return sorted unique tags");
    }
  },
  {
    ...
    test: () => {
      ...
      expectArrayLength(result, 0, "Should return empty array for empty collection");
  ...
  },
  {
    ...
    test: () => {
      ...
      expectArrayLength(result, 0, "Should return empty array when no tags exist");
    }
  },
  {
  ...
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['javascript', 'web'], "Should return only non-empty tags");
    }
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['javascript', 'web'], "Should return unique tags");
    }
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['apple', 'banana', 'zebra'], "Should return tags in alphabetical order");
    }
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['visible'], "Should only include pages with URL");
    }
  },
  {
  ...
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['another', 'valid'], "Should return only tags from valid, indexed pages");
    }
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['tag1', 'tag2', 'tag3'], "Should properly flatten and sort tags");
    }
  },
  {
    ...
    test: () => {
      ...
      expectStrictEqual(mockConfig.filters.tags, extractTags, "Should use correct filter function");
    }
  },
  {
  ...
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(collectionCopy, originalCollection, "Should not modify input collection");
    }
  },
  {
    ...
    test: () => {
      ...
      expectDeepEqual(result, ['0', '123', 'normal', 'spaced', 'text', 'valid'], "Should convert numbers to strings and handle edge cases");
      expectStrictEqual(result.every(tag => typeof tag === 'string'), true, "Should only return strings");
    }
  }
];
