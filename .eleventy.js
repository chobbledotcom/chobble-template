module.exports = async function (eleventyConfig) {
	...
	const { addThumbnailBackgrounds } = require("./src/_lib/image-transform");
	const { imageShortcode } = require("./src/_lib/image-shortcode");
	...
	eleventyConfig.addTransform("processImages", (content, outputPath) => {
		if (!outputPath || !outputPath.endsWith(".html")) return content;
		return addThumbnailBackgrounds(content);
	});
