  ...
  - type: features
    items:
      - icon: "hugeicons:tag-01"
        name: Model
        description: Original 1970 Design Reissue
      - icon: "hugeicons:cube"
        name: Materials
        description: Die-cast metal with chrome plating
      - icon: "hugeicons:gears"
        name: Mechanism
        description: Precision mechanical movement
      - icon: "hugeicons:ruler"
        name: Dimensions
        description: 20cm x 15cm x 8cm
