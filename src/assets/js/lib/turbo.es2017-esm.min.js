...
class StreamMessage {
	...
	static wrap(e) {
		return "string" == typeof e
			? new StreamMessage(createDocumentFragment(e))
			: e;
	}
	constructor(e) {
...
var Idiomorph = (() => {
	...
	const r = (() => {
		...
		s = (() => {
			...
			return (n, o, a) =>
				a.ignoreActive && n === document.activeElement
					? null
	...
	const n = (() => {
			...
			return (i, n, o) => {
				const { persistentIds: a, idMap: c } = ((e, t) => {
						const i = r(e),
							n = r(t),
							o = ((e, t) => {
								const r = new Set(),
		...
		{ normalizeElement: o, normalizeParent: a } = (() => {
			const e = new WeakSet();
			return {
				normalizeElement: (e) =>
					e instanceof Document ? e.documentElement : e,
						...
						return t(
							((t) => {
								...
								if (
									...
									const i = r.parseFromString(t, "text/html");
...
class PageSnapshot extends Snapshot {
	static fromHTMLString(e = "") {
		return PageSnapshot.fromDocument(parseHTMLDocument(e));
	}
	static fromElement(e) {
		return PageSnapshot.fromDocument(e.ownerDocument);
	}
	static fromDocument({ documentElement: e, body: t, head: r }) {
		return new PageSnapshot(e, t, new HeadSnapshot(r));
	}
	constructor(e, t, r) {
...
const deprecatedLocationPropertyDescriptors = {
	...
	{ cache, navigator: navigator$1 } = session;
function start() {
	session.start();
}
